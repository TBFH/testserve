...
#         deployments=['jetson-64g-4', 'jetson-16g-3', 'jetson-16g-6', 'jetson-8g-1'],
#         gpu_memory_utilization=0.01,
#         max_batch_size=1,
#         enable_records=True
#     )
...
import argparse
from testserve.llm import TestOfflineLLM_BS1, SamplingParams
...
llm = TestOfflineLLM_BS1(
    ...
    pipeline_parallel_size=4,
    # pipeline_distribution=[6,6,6,6],
    deployments=['jetson-64g-4', 'jetson-16g-2', 'jetson-16g-3', 'jetson-16g-8'],
    gpu_memory_utilization=0.8,
)

# Generate texts from the prompts. The output is a list of Request objects
# that contain the prompt, generated text, and other information.
outputs, _, _ = llm.generate(prompts=prompts, sampling_params=sampling_params)
